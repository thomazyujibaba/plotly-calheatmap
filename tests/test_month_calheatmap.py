...
from plotly_calheatmap import month_calheatmap


class TestMonthCalplot(TestCase):
    def setUp(self) -> None:
        # Data copied on 2022-04-27 from test_calheatmap.py
    ...
    def test_should_create_one_year_only(self) -> None:
        cp = month_calheatmap(self.one_year_sample_dataframe, "ds", "value")
    ...
    def test_should_create_multi_year(self) -> None:
        cp = month_calheatmap(self.multi_year_sample_dataframe, "ds", "value")
